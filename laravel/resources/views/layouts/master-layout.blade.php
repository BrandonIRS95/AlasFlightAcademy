...
<div class="Application_container">
    ...
    <ul id="side-nav" class="Sidenav__list side-nav">
        ...
        <li class="Sidenav__item"><a href="{{route('about')}}" class="Sidenav__item_link"><span class="Sidenav__item_text">{{ trans('messages.about') }}</span></a></li>
        <li class="Sidenav__item"><a href="{{route('pilot-programs')}}" class="Sidenav__item_link"><span class="Sidenav__item_text">{{ trans('messages.pilot_programs') }}</span></a></li>
        <li class="Sidenav__item"><a href="{{route('contact')}}" class="Sidenav__item_link"><span class="Sidenav__item_text">{{ trans('messages.contact') }}</span></a></li>
        <li class="Sidenav__item"><a href="#become-pilot" class="Sidenav__item_link"><span class="Sidenav__item_text">{{ trans('messages.become_a_pilot') }}</span></a></li>
        <li class="Sidenav__item"><a href="{{route('enroll')}}" class="Sidenav__item_link"><span class="Sidenav__item_text">{{ trans('messages.enroll_now') }}</span></a></li>
        <li class="Sidenav__item"><a href="{{route('signin')}}" class="Sidenav__item_link"><span class="Sidenav__item_text">{{ trans('messages.signin') }}</span></a></li>
    </ul>
    ...
    <footer class="Footer">
        <ul class="Footer__list">
            <li class="Footer__list_item"><a href="{{route('about')}}" class="Footer__link">{{ trans('messages.about') }}</a></li>
            <li class="Footer__list_item"><a href="{{route('pilot-programs')}}" class="Footer__link">{{ trans('messages.pilot_programs') }}</a></li>
            <li class="Footer__list_item"><a href="{{route('contact')}}" class="Footer__link">{{ trans('messages.contact') }}</a></li>
            <li class="Footer__list_item"><a class="Footer__link">{{ trans('messages.become_a_pilot') }}</a></li>
            <li class="Footer__list_item"><a href="{{route('signin')}}" class="Footer__link">{{ trans('messages.signin') }}</a></li>
            <li class="Footer__list_item"><a href="{{route('enroll')}}" class="Footer__link">{{ trans('messages.enroll_now') }}</a></li>
        </ul>
