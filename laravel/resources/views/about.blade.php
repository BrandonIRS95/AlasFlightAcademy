...
@section('content')
  <div class="Page__header parallax-container">
    ...
    <div class="Page__header__text">{{trans('messages.about')}}</div>
  </div>
  <div class="CTA_bar">
  ...
  <div class="About__history">
    <h3 class="About__history__title">{{trans('messages.history')}}</h3>
  ...
  <div class="About__founder parallax-container">
    ...
    <h3 class="About__founder__title">{{trans('messages.about_founder')}}</h3>
